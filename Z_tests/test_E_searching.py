...
from E_searching.recursive import B_ternary_search_recursive
...
class Test_E_searching:
    ...
    def test_B_ternary_search_recursive(self):
        n = 7
        l = [i for i in range(10)]
        assert B_ternary_search_recursive.ternary(l, 0, len(l) - 1, n) == 7
